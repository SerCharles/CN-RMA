...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='checkpoint file', type=str, default='/home/sgl/work_dirs_atlas/ray_marching_neus_300_005.pth')
    parser.add_argument('--work-dir', help='the dir to save logs and models', type=str, default='/data1/sgl/test')
