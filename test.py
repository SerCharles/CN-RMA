...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='checkpoint file', type=str, default='/home/sgl/work_dirs_atlas/ray_marching_base_points.pth')
    parser.add_argument('--work-dir', help='the dir to save logs and models', type=str, default='/home/sgl/work_dirs_atlas/atlas_ray_marching_points')
