...
def evaluate_bbox(data_path, result_path):
    ...
    for scene_id in scene_ids:
        box_path = os.path.join(result_path, scene_id, scene_id + '_fcaf3d_mine.npz')
        result = {} 
...
if __name__ == '__main__':
    ...
    parser.add_argument("--result_path", type=str, default='/data/shenguanlin/atlas_test/results')
