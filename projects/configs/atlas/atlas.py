...
workflow = [('train', 1)]
total_epochs = 200 
evaluation = dict(interval=500, voxel_size=VOXEL_SIZE, save_path=work_dir+'/results')
...
test_pipeline = [
    dict(type='ResizeImage', size=((640, 480))),
    dict(type='AtlasToTensor'),
    dict(type='RandomTransformSpace', voxel_dim=VOXEL_DIM_TEST, voxel_size=VOXEL_SIZE, 
